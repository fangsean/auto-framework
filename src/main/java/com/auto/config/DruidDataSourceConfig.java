...
import com.auto.config.properties.DruidSettings;
...
public class DruidDataSourceConfig {
    ...
    public DruidDataSource dataSource() throws Exception {
        ...
        if (druidSettings.isPoolPreparedStatements()) {
            dataSource.setMaxPoolPreparedStatementPerConnectionSize(druidSettings
        ...
        statFilter.setSlowSqlMillis(druidSettings.getSlowSqlMillis());
